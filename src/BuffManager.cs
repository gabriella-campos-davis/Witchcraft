...
namespace BuffStuff {
  public class BuffManager {
    ...
    public static Dictionary<string, Type> buffTypes = new Dictionary<string, Type>();
    ...
    public static Dictionary<string, Buff> buffIds = new Dictionary<string, Buff>();
    ...
    public static Buff GetBuffById(string id){
      Buff buff;
      foreach(KeyValuePair<string, Buff> buffs in buffIds){
        if(buffs.Key == id){
          buff = buffs.Value;
          return buff;
        } 
    ...
    private static Buff deserializeBuff(SerializedBuff serializedBuff, Entity entity) {
      ...
      buffIds.Add(serializedBuff.id, buff);
      return buff;
    }
